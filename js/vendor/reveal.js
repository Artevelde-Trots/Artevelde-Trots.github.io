...
(function (root, factory) {
    ...
    function configure(options) {
        ...
        if (config.mouseWheel) {
            ...
            slide.addEventListener('DOMMouseScroll', onDocumentMouseScroll, false); // FF
    ...
    function layout() {
        ...
        if (dom.wrapper && !isPrintingPDF()) {
            ...
            //fdom.slides.style.height = size.height + 'px';
    ...
    function onDocumentMouseScroll(event) {
        /**
         *  ADDED IF STATEMENT TO PREVENT SCROLLING
         *  WHILE THE INTRO PAGE IS ACTIVE - Lotte Verwerft
         *
         *  ALSO UPDATED MOUSEWHEELSTEP FROM 600 - 1150 TO PREVENT
         *  MULTIPLE SLIDES FROM SLIDING.  - Lotte Verwerft
         *
         *  ALSO ADDED SIDE SCROLL - author Jens de Wulf
         **/
        var intro = document.querySelector('.intro');
        if (intro.classList.contains('hide')) {
            if (Date.now() - lastMouseWheelStep > 1150) {
